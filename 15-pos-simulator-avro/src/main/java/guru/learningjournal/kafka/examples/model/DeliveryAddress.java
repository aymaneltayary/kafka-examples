...
public class DeliveryAddress extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5894027466262794028L;
   ...
   */
  public static guru.learningjournal.kafka.examples.model.DeliveryAddress.Builder newBuilder() {
    return new guru.learningjournal.kafka.examples.model.DeliveryAddress.Builder();
  }
   ...
   * @return A new DeliveryAddress RecordBuilder
   */
  public static guru.learningjournal.kafka.examples.model.DeliveryAddress.Builder newBuilder(guru.learningjournal.kafka.examples.model.DeliveryAddress.Builder other) {
    if (other == null) {
      return new guru.learningjournal.kafka.examples.model.DeliveryAddress.Builder();
    } else {
      return new guru.learningjournal.kafka.examples.model.DeliveryAddress.Builder(other);
    }
  }
   ...
   * @return A new DeliveryAddress RecordBuilder
   */
  public static guru.learningjournal.kafka.examples.model.DeliveryAddress.Builder newBuilder(guru.learningjournal.kafka.examples.model.DeliveryAddress other) {
    if (other == null) {
      return new guru.learningjournal.kafka.examples.model.DeliveryAddress.Builder();
    } else {
      return new guru.learningjournal.kafka.examples.model.DeliveryAddress.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DeliveryAddress>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(guru.learningjournal.kafka.examples.model.DeliveryAddress.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(guru.learningjournal.kafka.examples.model.DeliveryAddress other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.addressLine)) {
        this.addressLine = data().deepCopy(fields()[0].schema(), other.addressLine);
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.examples.model.DeliveryAddress.Builder setAddressLine(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.examples.model.DeliveryAddress.Builder clearAddressLine() {
      addressLine = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.examples.model.DeliveryAddress.Builder setCity(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.examples.model.DeliveryAddress.Builder clearCity() {
      city = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.examples.model.DeliveryAddress.Builder setState(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.examples.model.DeliveryAddress.Builder clearState() {
      state = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.examples.model.DeliveryAddress.Builder setPinCode(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.examples.model.DeliveryAddress.Builder clearPinCode() {
      pinCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.examples.model.DeliveryAddress.Builder setContactNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.examples.model.DeliveryAddress.Builder clearContactNumber() {
      contactNumber = null;
