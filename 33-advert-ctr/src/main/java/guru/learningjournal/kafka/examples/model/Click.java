...
public class Click {
    ...
    public Click withImpressionId(String impressionId) {
        this.impressionId = impressionId;
        return this;
    }
    ...
    public Click withCampaigner(String campaigner) {
        this.campaigner = campaigner;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Click.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
